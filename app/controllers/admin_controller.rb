class AdminController < ApplicationController
    ...
    def index
        #Stored the 5 most recent orders that are not fulfilled
        @orders = Order.where(fullfilled: false).order(created_at: :desc).take(5)
        #Stats with the total number of orders, revenue, average cost of each sale all within the last day
        @quick_stats = {
        ...
        #all orders made in the last 7 days in order of creation
