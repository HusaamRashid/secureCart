...
module Admin
  class ProductsController < AdminController
    ...
    def new
      ...
      # @admin_product_id = @admin_product.find(params[:id])
    end
    ...
    def update
      # Updates the product but does not delete any uploaded images ensuring the admin doesnt have to reupload images everytime the product is edited
    ...
    def destroy
      ...
      respond_to do |format|
        format.html do
          redirect_to admin_products_path(@admin_product), status: :see_other,
